...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 159);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 134);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 159);
